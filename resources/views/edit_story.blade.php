...
<h1 class="m-4">Edit a Story or Poem</h1>
<br>
<div class="container">
    ...
    <div class="col-xs-12 card p-4">  
        ...
        <div>  
            ...
            <input class="art_ttl" id="ttl1" type="text" maxlength="100" value="{{$s->title}}"><br>    
            ...
            <div class="art_cnt" contenteditable><?php echo html_entity_decode($s->content); ?></div>
            <br>
            <button onclick="saveToDB('{{$s->id}}')" class="btn btn-info"> <i class="fa fa-save fa-lg"></i> Save </button>
            <br>
        </div>
    </div>
...
<script>
    ...
    function saveToDB(id){
        ...
        var sid = id;
        var url1 = '/admin/update_story/' + sid;
            $.ajax({
                url: url1,
                type: "POST",
                data: {
                ...
                success:function (data) {
                    ...
                    window.location.href = "/admin/mystories";
                    }, 1000);
                }, error: function (data){
                    console.log(data);
                }
